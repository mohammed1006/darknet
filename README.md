...
* Output json file of objects & coordinates: `darknet.exe detector test data/coco.data yolov3.cfg yolov3.weights -thresh 0.25 dog.jpg -ext_output -dont_show -save_json_output`
...
* Output json file of objects & cordinates per frame: `darknet.exe detector demo data/coco.data yolov3.cfg yolov3.weights -thresh 0.25 test.mp4 -dont_show -save_json_output -output_prefix outputdir/testmp4`
