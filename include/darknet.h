...
void demo(char *cfgfile, char *weightfile, float thresh, char* cam_index, const char *filename, char **names, int classes, int frame_skip, char *prefix, int avg, float hier_thresh, int w, int h, int fps, int fullscreen);
...
size_t rand_size_t();
float rand_normal();
void setupSocket(char*,int,float);
