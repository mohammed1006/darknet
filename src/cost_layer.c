...
void resize_cost_layer(cost_layer *l, int inputs)
{
    l->inputs = inputs;
    l->outputs = inputs;
    l->delta = (float*)xrealloc(l->delta, inputs * l->batch * sizeof(float), __FILE__, __LINE__);
    l->output = (float*)xrealloc(l->output, inputs * l->batch * sizeof(float), __FILE__, __LINE__);
#ifdef GPU
